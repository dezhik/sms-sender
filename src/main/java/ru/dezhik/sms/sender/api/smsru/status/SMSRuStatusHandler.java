 ...
 * @author ilya.dezhin
 */
public class SMSRuStatusHandler extends AbstractSMSRuApiHandler<SMSRuStatusRequest, SMSRuSimpleResponse> {
    @Override
    ...
    @Override
    public SMSRuSimpleResponse parseResponse(SMSRuStatusRequest request, String responseStr) {
